...
Hello! Welcome to the tutorial for R. In order to participate in the course, you will need to install three pieces of software onto your computer.
...
1. Download and install [R for Windows](https://cran.r-project.org/bin/windows/base/R-4.3.1-win.exe)

2. Download and install [Rtools for Windows](https://cran.r-project.org/bin/windows/Rtools/rtools43/files/rtools43-5550-5548.exe)
...
`RTutorial` allows students to unpack and complete questions.
Materials were originally developed by Will Lowe and Marc Ratkovic 
in Fall 2019.
...
```
RTutorial::get_handout(1, newname = "handout1-for-real")
```
...
```{r}
RTutorial::get_precept_answers(1)
```
...
[![Travis-CI Build Status](https://travis-ci.org/conjugateprior/RTutorial.svg?branch=master)](https://travis-ci.org/conjugateprior/RTutorial) [![Build status](https://ci.appveyor.com/api/projects/status/rfj426c7ddq4ni72?svg=true)](https://ci.appveyor.com/project/conjugateprior/pol345-student)
